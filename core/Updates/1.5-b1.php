...
class Updates_1_5_b1 extends Updates
{
    ...
    public function getMigrations(Updater $updater)
    {
        ...
        $logConversionItemTable = Common::prefixTable('log_conversion_item');
        ...
        return array(
            ...
            $this->migration->db->addPrimaryKey('log_conversion_item', array('idvisit', 'idorder', 'idaction_sku')),
            ...
            $this->migration->db->sql('ALTER TABLE `' . Common::prefixTable('log_conversion') . '` ADD UNIQUE KEY unique_idsite_idorder (idsite, idorder)',
                                      Updater\Migration\Db::ERROR_CODE_DUPLICATE_KEY)
        );
    }
