...
class Updates_0_2_10 extends Updates
{
    ...
    public function getMigrations(Updater $updater)
    {
        return array(
            ...
            $this->migration->db->addPrimaryKey('option', array('idoption', 'option_name')),
            ...
            $this->migration->db->changeColumnType('logger_error', 'message', 'TEXT'),
            $this->migration->db->changeColumnType('logger_exception', 'message', 'TEXT'),
            $this->migration->db->changeColumnType('logger_message', 'message', 'TEXT'),
